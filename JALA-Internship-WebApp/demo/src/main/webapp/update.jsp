			...
			<div class="col py-3">
				...
				<div class="col mx-3 my-5">
					...
					<div
						...
						<form:form action="${pageContext.request.contextPath}/edited"
							modelAttribute="studentbean" method="post">

							<c:forEach var="sb" items="${stbean}">

								<h2>Update Job-Seeker Details of ID: ${sb.studentId}</h2>
								<hr>
								<br>
								<br>
								...
								<div class="row">
									...
									<div class="col-4 px-4">
										...
										<hr>
										<form:input class="form-control" path="activeTill" type="date"
											value="${sb.activeTill}" max="<%= avaldate %>"
											min="<%= today %>"></form:input>
